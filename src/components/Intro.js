...
import img from '../images/developer-thinking.svg';
                ...
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6" id='about' >
                    ...
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="fade-up">
                        ...
                        <div className="flex-col my-4 text-center lg:text-left lg:my-0 lg:justify-end w-full lg:w-1/2 px-8" data-aos="zoom-in" data-aos-delay="500">
                            ...
                            <h3 className="text-3xl  text-black font-bold">We create top-notch, tailor-made web and AI-powered solutions for businesses, institutions, and small to medium enterprises</h3>
                            <div>
